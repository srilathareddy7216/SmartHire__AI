...
def render_auth_gate() -> None:
    """Renders a Login / Sign up tabbed form. Call this before any protected
    content, then st.stop() if is_authenticated() is still False."""
    st.markdown("## 🔐 Welcome to SmartHire")
